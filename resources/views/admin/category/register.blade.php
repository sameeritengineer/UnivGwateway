...
<div class="row"> 
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-md-10">
                <input value="{{ old('name') }}" class="form-control border-primary" type="text" placeholder="Category Name:" id="userinput5" name="name" required="">
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-md-10">
                 <input value="{{ old('sort') }}" class="form-control border-primary" type="text" placeholder="Sort:" id="userinput5" name="sort" required="">
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group row">
            <div class="col-md-12">
                <textarea required="" maxlength="260" id="userinput8" rows="6" class=" form-control border-primary" name="description" placeholder="Enter Description"></textarea>
            </div>
        </div>
    </div>
</div>
