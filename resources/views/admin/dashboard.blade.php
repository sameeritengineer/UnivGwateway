                                ...
                                <div id="recent-buyers" class="media-list height-300 position-relative">
                                    <a href="#" class="media border-0">
                                        <div class="media-left pr-1">
                                            <div class="avatar avatar-online avatar-md"><img class="media-object rounded-circle" src="{{asset('admin/app-assets/images/portrait/small/avatar-s-7.png')}}" alt="Generic placeholder image">
                                                <i></i>
                                            </div>
                                        </div>
                                    ...
                                    <a href="#" class="media border-0">
                                        <div class="media-left pr-1">
                                            <div class="avatar avatar-away avatar-md"><img class="media-object rounded-circle" src="{{asset('admin/app-assets/images/portrait/small/avatar-s-8.png')}}" alt="Generic placeholder image">
                                                <i></i>
                                            </div>
                                        </div>
                                        <div class="media-body w-100">
                                    ...
                                    <a href="#" class="media border-0">
                                        <div class="media-left pr-1">
                                            <div class="avatar avatar-busy avatar-md"><img class="media-object rounded-circle" src="{{asset('admin/app-assets/images/portrait/small/avatar-s-9.png')}}" alt="Generic placeholder image">
                                                <i></i>
                                            </div>
                                        </div>
                                        <div class="media-body w-100">
                                    ...
                                    <a href="#" class="media border-0">
                                        <div class="media-left pr-1">
                                            <div class="avatar avatar-online avatar-md"><img class="media-object rounded-circle" src="{{asset('admin/app-assets/images/portrait/small/avatar-s-10.png')}}" alt="Generic placeholder image">
                                                <i></i>
                                            </div>
                                        </div>
                                        <div class="media-body w-100">
                                    ...
                                    <a href="#" class="media border-0">
                                        <div class="media-left pr-1">
                                            <div class="avatar avatar-online avatar-md"><img class="media-object rounded-circle" src="{{asset('admin/app-assets/images/portrait/small/avatar-s-11.png')}}" alt="Generic placeholder image">
                                                <i></i>
                                            </div>
                                        </div>
                                        <div class="media-body w-100">
                                    ...
                                    <a href="#" class="media border-0">
                                        <div class="media-left pr-1">
                                            <div class="avatar avatar-away avatar-md"><img class="media-object rounded-circle" src="{{asset('admin/app-assets/images/portrait/small/avatar-s-12.png')}}" alt="Generic placeholder image">
                                                <i></i>
                                            </div>
                                        </div>
                                        <div class="media-body w-100">
                ...
                <div class="row match-height">
                    ...
                    <div class="col-xl-4 col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <img class="img-fluid" src="{{asset('admin/app-assets/images/carousel/06.jpg')}}" alt="Card image cap">
                                <div class="card-body">
